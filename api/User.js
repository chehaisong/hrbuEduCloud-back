...
router.get("/userinfo", (req, res) => {
    ...
    condition = condition.join(" ");
     ...
     //查询用户表
    const sql = `SELECT id,username,email,gender,state,ts FROM USER ${condition} ORDER BY ts DESC LIMIT ${(query.pageNum-1)*query.pageSize}, ${query.pageSize};`;
    console.log(sql);
...
router.post("/resetpassword", (req,res) => {
    ...
    // console.log([...params.userIds,...params.userIds]);
    // console.log(params.userIds.concat(params.userIds));
